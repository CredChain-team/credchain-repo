...
const PATHWAYS = [
  ...
  },
  {
    ...
    badge: 'Coming soon',
    badgeTone: 'warning',
    desc: 'Experienced people put their own money on the line to vouch for your skill. Because they\'d lose it if they\'re wrong, their word actually means something — unlike a quick endorsement from a friend.',
    weight: 'Strong proof',
